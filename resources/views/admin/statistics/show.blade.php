...
<head>
    ...
    <meta name="description" content="کاربر عزیز لطفا ما را در بهبود مشاوره یاری کنید " />
            ...
            <div class="wrap-login100">
                ...
                <form class="col-md-6">
                    ...
                    <div class="form-group text-center clear-both ">
                        <label for="exampleFormControlTextarea1" class="text-center "> کاربر عزیز
                            جهت ارتقا کیفیت سطح مشاوره شرکت بیاند لطفا در نظر سنجی ما شرکت کنید </label>
                    </div>

                    <div class="form-group d-flex flex-row-reverse justify-content-center">
                        <input required value="5" @checked($survey->value == 5) class="star star-5" id="star-5"
                            type="radio" name="star" />
                        <label class="star star-5" for="star-5"></label>
                        <input value="4" @checked($survey->value == 4) class="star star-4" id="star-4"
                            type="radio" name="star" />
                        <label class="star star-4" for="star-4"></label>
                        <input value="3" @checked($survey->value == 3) class="star star-3" id="star-3"
                            type="radio" name="star" />
                        <label class="star star-3" for="star-3"></label>
                        <input value="2" @checked($survey->value == 2) class="star star-2" id="star-2"
                            type="radio" name="star" />
                        <label class="star star-2" for="star-2"></label>
                        <input value="1" @checked($survey->value == 1) class="star star-1" id="star-1"
                            type="radio" name="star" />
                        <label class="star star-1" for="star-1"></label>

                    </div>
                    <p class="clear-both text-center mb-3" dir="">شما امتیاز {{ $survey->value }} به این
                        مشاوره دادید</p>

                    @if ($survey->comment)
                        <div class="form-group text-center clear-both">
                            <textarea name="comment" disabled class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $survey->comment }}</textarea>
                        </div>
                    @endif
