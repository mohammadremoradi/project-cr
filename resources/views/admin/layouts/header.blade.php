    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            ...
            @can('client-search')
                <div class="navbar-search-block">
                    <form action="{{ route('search.clients') }}" method="get" class="form-inline">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-danger navbar-badge">{{ $unseenClients->count() }}</span>
            </a>
        ...
        @can('setting-user-page')
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <span class="dropdown-item dropdown-header"> {{ $unseenUsers->count() }}
                        Notifications</span>
                    <div class="dropdown-divider"></div>
