            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('mail-file.index' , $email->id) }}">Email File</a></li>
                        <li class="breadcrumb-item active">Create Email File</li>
                    </ol>
                </div>
            </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{ route('mail-file.store' , $email->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="row p-2">
                                <section class="col-6">
