                        ...
                        <form action="{{ route('sms.store') }}" method="POST">
                            ...
                            <div class="row p-2">
                                <div class="form-floating mb-3 c col-md-4">
                                    <input name="title" value="{{ old('title') }}" type="text" onkeyup="counterTitle(this)" required
                                ...
                                <div class="form-floating">
                                    <textarea dir="rtl" name="body" onkeyup="counterBody(this)" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
