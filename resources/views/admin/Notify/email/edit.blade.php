                        ...
                        <form action="{{ route('email.update', $email->id) }}" method="POST">
                            ...
                            <div class="row p-2">
                                <div class="form-floating mb-3 c col-md-4">
                                    <input name="subject" value="{{ old('subject', $email->subject) }}" type="text"
                                ...
                                <section class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="published_at" value="{{ $email->published_at }}"
                                            id="published_at" class="form-control form-control-sm d-none ">
                                        <input type="text" id="published_at_view" value="{{ $email->published_at }}"
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select dir="rtl" class="form-select" name="tag_id" id="floatingSelect"
                                        ...
                                        @foreach ($tags as $tag)
                                            <option value="{{ $tag->id }}" @selected($tag->id == $email->tag_id)>
                                                {{ $tag->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating">
                                    <textarea name="body" onkeyup="counterBody(this)" class="form-control" placeholder="Leave a comment here"
                                        id="floatingTextarea2"
                                        style="height: 100px">{{ old('body', $email->body) }}</textarea>
