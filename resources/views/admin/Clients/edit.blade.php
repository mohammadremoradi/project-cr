            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('client.my') }}">Clients</a></li>
                    ...
                    <div class="card">
                        <form action="{{ route('client.update', $client->id) }}" method="POST">
                            ...
                            <div class="row p-2">
                                ...
                                <div class="form-floating mb-3 c col-md-3">
                                    <input dir="rtl" name="degree" value="{{ old('degree', $client->degree) }}"
                                ...
                                <div class="row" dir="rtl">
                                    ...
                                    <div class="form-floating mb-3 col-md-4">
                                        <textarea dir="rtl" required class="form-control " name="discription" cols="3" rows="2" placeholder="Leave a comment here"
                                    ...
                                    <div class="form-floating mb-3 col-md-4">
                                        <select dir="rtl" class="form-select" name="intrest" id="floatingSelect"
                                            aria-label="Floating label select example">

                                            <option value="0%" @selected($client->intrest === '0%')>0%</option>
                                            <option value="50%" @selected($client->intrest === '50%')>50%</option>
                                            <option value="75%" @selected($client->intrest === '75%')>75%</option>
                                        </select>
                                        <label for="floatingSelect">intrest</label>
                                    </div>
                                    ...
                                    <div class="form- mb-3 c col-md-4">
                                        <label for=""> Consultation time today </label>
                                        <input dir="rtl" name="hours" placeholder="{{ old('hours', $client->hours) }}"
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select dir="rtl" class="form-select" name="status" id="floatingSelect"
                                        aria-label="Floating label select example">
                                        <option value="consulting" @selected($client->status == 'consulting')>In Consulting </option>
                                        <option value="done" @selected(old('status') || $client->status == 'done')>Registered</option>
                                        <option value="cancel" @selected($client->status == 'cancel')>Has Given Up</option>
                                    </select>
