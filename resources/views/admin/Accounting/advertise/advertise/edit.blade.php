            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{ route('advertise.update', $advertise->id) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            ...
                            <div class="row p-2">
                                ...
                                <div class="form-floating mb-3 col-md-4">
                                    <select dir="rtl" class="form-select" name="sourse_id" id="floatingSelect"
                                        ...
                                        @foreach ($sourses as $sourse)
                                            <option value="{{ $sourse->id }}" @selected($sourse->id == $advertise->sourse_id)>
                                                {{ $sourse->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-floating mb-3 c col-md-4">
                                    <input name="price" value="{{ old('price', $advertise->price) }}" type="text" required
                                ...
                                <div class="form-floating mb-3 c col-md-4">
                                    <input name="statistics" value="{{ old('statistics', $advertise->statistics) }}"
                                        type="text" required class="form-control" id="floatingInput"
                                        placeholder="statistics">
                                    <label for="floatingInput">Statistic</label>
                                    <span id="counterTitle" class="right badge badge-danger p-2"></span>
                                    <br>
                                    @error('statistics')
                                        <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
